...
func get_input():
#    velocity = Vector2()
#    if Input.is_action_pressed('ui_right_4'):
#        velocity.x += 1
#    if Input.is_action_pressed('ui_left_4'):
#        velocity.x -= 1
#    if Input.is_action_pressed('ui_down_4'):
#        velocity.y += 1
#    if Input.is_action_pressed('ui_up_4'):
#        velocity.y -= 1
